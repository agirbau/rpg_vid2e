...
python "$vid2e_path"/esim_torch/scripts/generate_events.py --input_dir="$vid2e_data_path"/example/upsampled --output_dir="$vid2e_data_path"/example/events --contrast_threshold_neg="$contrast_threshold_neg" --contrast_threshold_pos="$contrast_threshold_pos" --refractory_period_ns="$refractory_period_ns"
